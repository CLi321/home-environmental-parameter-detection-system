...
void POST_Data(void)
{
//		printf("hum temp=%f .%f, light=%d\r\n",STM32.sensor_temp,STM32.sensor_hum,STM32.sensor_light);

		ESP8266_SendData(STM32.sensor_temp, STM32.sensor_hum, STM32.sensor_light, STM32.sensor_MQ2, STM32.sensor_Voltage,\
											STM32.sensor_people_state, STM32.sensor_motion_distance, STM32.sensor_static_distance);		
		delay_ms(1000);
		ESP8266_Clear();

	
		ESP8266_SendData2(STM32.sensor_temp, STM32.sensor_hum, STM32.sensor_light, STM32.sensor_MQ2, STM32.sensor_Voltage,\
											STM32.sensor_people_state, STM32.sensor_motion_distance, STM32.sensor_static_distance);		
		delay_ms(1000);
		ESP8266_Clear();
}
