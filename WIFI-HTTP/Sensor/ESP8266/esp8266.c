...
char *str[4] = {"POST /devices/1170594174/datapoints HTTP/1.1",
                "api-key:WPTPmmlCMIu6YUyJOnCVbNGgMP4=",
...
u16 esp8266_get_data(char *vStr)
{
    ...
    u16 value = 0;
    char *back;
    char temp[160] = "GET /devices/1170594174/datastreams/";
...
void esp8266_start_trans(void)
{
    ...
    while (esp8266_send_cmd("AT+CWJAP=\"Tenda_764B60\",\"12345678\"", "WIFI GOT IP", 500)) 
		{
        delay_ms(1);
    };
